...
class User extends ActiveRecord implements IdentityInterface {
    ...
    public function scenarios() {
        return [
            ...
            'profile' => ['username', 'email', 'password','usertype'],
    ...
    public function attributeLabels() {
        return [
            ...
            'usertype' => Yii::t('auth.usertype', 'Usertype'),
    ...
    public function getUsertype() {
        return $this->hasOne(Usertype::className(), ['utype_id' => 'usertype']);
    }
    
    public function getUserTypes(){
        return Usertype::find()->asArray()->all();
    }
